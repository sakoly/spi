 ...
 */
#include <stdio.h>
#include <Sensors_Access_mcat6.h>
#include "main.h"
...
void MPU_atitude(double* a0,double* a1,double* a2,double* a3,int gygap_x,int gygap_y,int gygap_z){
	...
	//--------------------------
	  ...
	  dmf3=(mag1*(0.5-q22-q33)+mag3*(q13-q02)-MPU_Raw_Datasub[0]/2)*(-2*mag3*q3-mag3*q1)+
	...
	w1=(double)(MPU_Raw_Data[3]-gygap_x)*0.00026634862;//
	w2=(double)(MPU_Raw_Data[4]-gygap_y)*0.00026634862;
	w3=(double)(MPU_Raw_Data[5]-gygap_z)*0.00026634862;
	...
	q0=q0+rate*(dqw0-B*(C*dmf0/dmfsqrt+dgf0/dgfsqrt));
	q1=q1+rate*(dqw1-B*(C*dmf1/dmfsqrt+dgf1/dgfsqrt));
	q2=q2+rate*(dqw2-B*(C*dmf2/dmfsqrt+dgf2/dgfsqrt));
	q3=q3+rate*(dqw3-B*(C*dmf3/dmfsqrt+dgf3/dgfsqrt));
